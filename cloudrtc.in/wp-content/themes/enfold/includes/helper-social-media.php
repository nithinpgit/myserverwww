...
if(!class_exists('avia_social_media_icons'))
{
	class avia_social_media_icons
	{
		...
		function build_icon($icon)
		{
			...
			$html .= "<a {$blank} href='".$icon['social_icon_link']."'  id='".ucfirst($icon['social_icon'])."' title='".ucfirst($icon['social_icon'])."'><img border='0' src='http://alamanitech.com/wp-content/uploads/2016/12/".ucfirst($icon['social_icon']).".png'><span class='avia_hidden_link_text'>".ucfirst($icon['social_icon'])."</span></a>";
			$html .= "</".$this->args['inside'].">";
